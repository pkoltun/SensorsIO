...
Sensor.prototype.renderState = function () {
    return "<input value='" +JSON.stringify(this.getLastAvaliableState())+"'/><button type='button'>Update</button>"; 
}

Sensor.prototype.stateHandling = function (ws, container) {
